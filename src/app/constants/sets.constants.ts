...
export const cardSets: Set[] = [
    {
        ...
        cards: [
            ...
            },
            {
                ...
                extra: "Makes no sound at the beginning of a syllable. Turns a vowel into a full syllable block by forming a pair. "
            },
            {
        ...
        cards: [
            {
                ...
                extra: "Push your tongue forward slightly more forward than an English G would normally require."
            },
            {
                front: "ㅋ",
                back: '"K".',
            ...
            {
                front: "The thing that happens to the sound of a consonant when you add lines to it.",
    ...
    },
    {
        ...
        cards: [
            ...
            },
            {
                ...
                extra: 'This one is less intuitive because there\'s no "ee" or "oh" sounds'
            },
            {
                front: "ㅙ",
                back: '"Weh", but with a hint of "ai"',
        ...
        cards: [
            {
                front: "안녕하세요",
                back: "Hello",
                extra: "안녕 = well-being, peace, health. 하세요 = you do, do you?, please do."
            },
            {
                front: "감사합니다",
                back: "Thank you.",
                extra: "감사 = appreciation, thankfulness, gratitude. 합니다 = I do, I am doing. "
            },
            {
                front: "네",
                back: "Yes",
        ...
        cards: [
            {
                ...
                extra: '이 책은 = This book (topic of this sentence). "This book <unlike other books>"'
            },
            {
                front: "이/가",
                back: "Marks the subject of the sentence.",
                extra: '이 책이 = This book (subject of this sentence). "This book <other books notwithstanding>"'
            },
            {
